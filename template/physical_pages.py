...
class PhysicalPages:
    ...
    def setPageRecord(self, record, recordLocation):
        """
        Set the record's values into the physical pages

        :param record: record object
        :param recordLocation: [locType, locPRIndex, locBP(TP)Index]
    ...
    def hasCapacity(self):
        """ Returns True if PhysicalPages has capacity. Else return False """
